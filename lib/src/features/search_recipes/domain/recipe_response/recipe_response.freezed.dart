...
abstract class $RecipeResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? count, List<Recipe>? results});
}
...
class _$_RecipeResponse implements _RecipeResponse {
  _$_RecipeResponse({this.count, final List<Recipe>? results})
      : _results = results;
...
abstract class _RecipeResponse implements RecipeResponse {
  factory _RecipeResponse({final int? count, final List<Recipe>? results}) =
      _$_RecipeResponse;
