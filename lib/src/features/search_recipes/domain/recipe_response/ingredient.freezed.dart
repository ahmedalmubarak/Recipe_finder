...
class _$_Ingredient implements _Ingredient {
  ...
  @override
  String toString() {
    return 'Ingredient(displayPlural: $displayPlural, id: $id, displaySingular: $displaySingular, updatedAt: $updatedAt, name: $name, createdAt: $createdAt)';
  }
...
abstract class _Ingredient implements Ingredient {
  factory _Ingredient(
      ...
      final String? name,
      @JsonKey(name: 'created_at') final int? createdAt}) = _$_Ingredient;
